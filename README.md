...
## Description
Ce projet est une étude de php a travers la mise en place d'un "framework" basé sur le modèle mvc   
...
5. effectuez une requête http a la racine (ex : http://php-mvc.bwb/)
